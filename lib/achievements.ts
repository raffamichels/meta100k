...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  // Mapa do Tesouro — fases da jornada
  {
    key: "map_forest",
    icon: "🌲",
    title: "Desbravador",
    description: "Entrou na Floresta dos Primeiros Passos.",
    rarity: "common",
    xpReward: 100,
  },
  {
    ...
    description: "Chegou à Planície da Determinação.",
    rarity: "common",
    xpReward: 200,
  },
  {
    ...
    icon: "⛰️",
    title: "Escalador",
    description: "Conquistou a Montanha da Disciplina.",
    rarity: "rare",
    xpReward: 350,
  },
  {
    ...
    description: "Adentrou a Caverna do Ouro.",
    rarity: "rare",
    xpReward: 500,
  },
  {
    ...
    icon: "🏰",
    title: "Desafiante",
    description: "Chegou à Fortaleza dos Guardiões.",
    rarity: "epic",
    xpReward: 700,
  },
  {
    ...
    icon: "🌟",
    title: "Iluminado",
    description: "Cruzou o Portal da Riqueza.",
    rarity: "epic",
    xpReward: 1000,
  },
  {
    ...
    icon: "💎",
    title: "Quase Lá",
    description: "Entrou na Ante-Sala do Tesouro.",
    rarity: "epic",
    xpReward: 1500,
  },
  {
    ...
    icon: "👑",
    title: "Lendário",
    description: "Conquistou o Grande Tesouro.",
    rarity: "legendary",
    xpReward: 3000,
  },
  // ── Cofre do Diabo ───────────────────────────────────────────────────────────
  {
    ...
    description: "Registre sua primeira tentação resistida.",
    rarity: "common",
    xpReward: 30,
  },
  {
    ...
    icon: "🔒",
    title: "Guardião",
    description: "Resista a 10 tentações.",
    rarity: "common",
    xpReward: 75,
  },
  {
    ...
    icon: "🧘",
    title: "Monge Digital",
    description: "Resista a 50 tentações.",
    rarity: "rare",
    xpReward: 200,
  },
  {
    ...
    icon: "🏛️",
    title: "Asceta",
    description: "Resista a 100 tentações.",
    rarity: "epic",
    xpReward: 500,
  },
  {
    key: "devil_value_1k",
    icon: "💰",
    title: "Mil Protegidos",
    description: "Acumule R$1.000 no Cofre do Diabo.",
    rarity: "common",
    xpReward: 100,
  },
  {
    ...
    icon: "🗄️",
    title: "Cofre Robusto",
    description: "Acumule R$10.000 no Cofre do Diabo.",
    rarity: "rare",
    xpReward: 300,
  },
  {
    ...
    description: "Acumule R$50.000 no Cofre do Diabo.",
    rarity: "epic",
    xpReward: 800,
  },
  {
    ...
    description: "Registre tentações em 7 dias seguidos.",
    rarity: "rare",
    xpReward: 150,
  },
  {
    ...
    icon: "⚖️",
    title: "Linha Tênue",
    description: "Resista a uma tentação acima de R$5.000.",
    rarity: "epic",
    xpReward: 400,
  },
  {
    key: "devil_categories",
    icon: "🌐",
    title: "Generalista",
    description: "Resista em 5 categorias diferentes.",
    rarity: "rare",
    xpReward: 200,
  },
  // ── Simulador "E Se?" ─────────────────────────────────────────────────────
